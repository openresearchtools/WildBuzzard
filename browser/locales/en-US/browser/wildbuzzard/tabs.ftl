...
wildbuzzard-tabs-group =
    .label = WildBuzzard tabs
    .description = Where the tab and bookmarks toolbars sit, the extra menu entries, and automatic tab grouping.

wildbuzzard-tabs-position-heading =
    .label = Toolbar positions

wildbuzzard-tabs-tab-bar-position-select =
    .label = Tab bar position

wildbuzzard-tabs-tab-bar-option-top-above =
    .label = Above the navigation toolbar

wildbuzzard-tabs-tab-bar-option-top-below =
    .label = Below the navigation toolbar

wildbuzzard-tabs-tab-bar-option-bottom-above =
    .label = At the bottom, above the status bar

wildbuzzard-tabs-tab-bar-option-bottom-below =
    .label = At the bottom, below the status bar

wildbuzzard-tabs-bookmarks-bar-position-select =
    .label = Bookmarks toolbar position

wildbuzzard-tabs-bookmarks-bar-option-top =
    .label = Top

wildbuzzard-tabs-bookmarks-bar-option-bottom =
    .label = Bottom

wildbuzzard-tabs-menu-heading =
    .label = Tab context menu

wildbuzzard-tabs-duplicate-menu-toggle =
    .label = Show the duplicate tab entry

wildbuzzard-tabs-copy-url-menu-toggle =
    .label = Show the copy tab URL entry

wildbuzzard-tabs-copy-active-url-toggle =
    .label = Copy the URL of the active tab instead of the clicked tab

wildbuzzard-tabs-copy-all-urls-menu-toggle =
    .label = Show the copy all tab URLs entry

wildbuzzard-tabs-restart-heading =
    .label = Restarting

wildbuzzard-tabs-restart-menu-toggle =
    .label = Show a restart entry in the menus

wildbuzzard-tabs-restart-confirm-toggle =
    .label = Ask for confirmation before restarting

wildbuzzard-tabs-restart-clear-cache-toggle =
    .label = Clear the startup cache when restarting

wildbuzzard-tabs-display-heading =
    .label = Tab display

wildbuzzard-tabs-pinned-icon-only-toggle =
    .label = Shrink pinned tabs to just the site icon

wildbuzzard-tabs-hide-close-buttons-toggle =
    .label = Hide the close button on tabs

wildbuzzard-tabs-grouping-heading =
    .label = Automatic tab grouping

wildbuzzard-tabs-auto-group-toggle =
    .label = Group new tabs with the tab that opened them

wildbuzzard-tabs-auto-group-placement-select =
    .label = Where new tabs join the group

wildbuzzard-tabs-auto-group-placement-option-after =
    .label = After the tab that opened them

wildbuzzard-tabs-auto-group-placement-option-first =
    .label = At the start of the group

wildbuzzard-tabs-auto-group-placement-option-last =
    .label = At the end of the group

wildbuzzard-copy-url-notification = URL copied
