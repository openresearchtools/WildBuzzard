...
wildbuzzard-appearance-statusbar-heading =
    .label = Status Bar

wildbuzzard-appearance-statusbar-enabled-toggle =
    .label = Show status bar
    .description = Display a toolbar at the bottom of the window.

wildbuzzard-appearance-statusbar-links-toggle =
...
wildbuzzard-defaults =
    .label = WildBuzzard Defaults
...
enable-wildbuzzard-theme-0 =
    .label = Enable WildBuzzard theme customisations on all themes

enable-wildbuzzard-theme-1 =
    .label = Enable WildBuzzard theme customisations on WildBuzzard themes

enable-wildbuzzard-theme-2 =
    .label = Disable WildBuzzard theme customisations
...
wildbuzzard-appearance-browser-style-group =
    .label = Browser style
    .description = Choose the overall WildBuzzard look.

wildbuzzard-appearance-browser-style-option-nova =
    .label = Nova
    .title = The signature WildBuzzard look on stock browser chrome.

wildbuzzard-appearance-browser-style-option-proton =
    .label = Proton
    .title = Modern stock browser styling.

wildbuzzard-appearance-browser-style-option-photon =
    .label = Photon
    .title = Classic WildBuzzard styling with refined chrome.

wildbuzzard-appearance-theme-colors-group =
    .label = Color Palette
...
wildbuzzard-appearance-theme-mode-option-light =
    .label = Light

wildbuzzard-appearance-theme-mode-option-dark =
    .label = Dark

wildbuzzard-appearance-theme-color-picker =
    .label = Theme color

wildbuzzard-appearance-theme-color-option-default =
    .label = Default

wildbuzzard-appearance-theme-color-option-smoke =
    .label = Smoke

wildbuzzard-appearance-theme-color-option-ash =
    .label = Ash

wildbuzzard-appearance-theme-color-option-sun =
    .label = Sun

wildbuzzard-appearance-theme-color-option-spark =
    .label = Spark

wildbuzzard-appearance-theme-color-option-flame =
    .label = Flame

wildbuzzard-appearance-theme-color-option-flare =
    .label = Flare

wildbuzzard-appearance-theme-color-option-lavender =
    .label = Lavender

wildbuzzard-appearance-theme-color-option-dusk =
    .label = Dusk

wildbuzzard-appearance-theme-color-option-lagoon =
    .label = Lagoon

wildbuzzard-appearance-theme-color-option-tide =
    .label = Tide

wildbuzzard-appearance-theme-color-option-pine =
    .label = Pine

wildbuzzard-appearance-details-group =
    .label = More appearance options
    .description = Fine tune the WildBuzzard interface.

wildbuzzard-appearance-transparent-toggle =
    .label = Transparent panels and menus

wildbuzzard-appearance-autohide-tabbar-toggle =
    .label = Hide the tab bar until you point at it

wildbuzzard-appearance-autohide-bookmarks-toggle =
    .label = Hide the bookmarks toolbar until you point at it

wildbuzzard-appearance-autohide-sidebar-toggle =
    .label = Hide the sidebar until you point at it

wildbuzzard-appearance-autohide-navigation-toggle =
    .label = Hide the back and forward buttons when they do nothing

wildbuzzard-appearance-close-button-hover-toggle =
