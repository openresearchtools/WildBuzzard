...
import { isPrivateBrowsingContext } from "resource:///modules/WildBuzzardBlockerUtils.sys.mjs";
 ...
 */
export class WildBuzzardBlockedPageParent extends JSWindowActorParent {
  receiveMessage(message) {
    if (message.name !== "WildBuzzardBlockedPage:AllowAndNavigate") {
      return undefined;
    }
    ...
    if (
      !WildBuzzardBlockerService.wasHostBlockedFor(browserId, hostname, url)
    ) {
      return false;
    }
