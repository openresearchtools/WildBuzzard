...
const CSS_URI =
  "chrome://browser/content/wildbuzzard/tabfeatures/tabfeatures.css";
...
export const TabFeatures = {
  ...
  async _showCopyNotification(win, url) {
    try {
      const l10n = new Localization(["browser/wildbuzzard/tabs.ftl"], true);
      const title = l10n.formatValueSync("wildbuzzard-copy-url-notification");
