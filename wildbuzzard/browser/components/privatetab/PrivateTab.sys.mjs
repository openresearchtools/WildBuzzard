...
const CSS_URI =
  "chrome://browser/content/wildbuzzard/privatetab/privatetab.css";
...
export const PrivateTab = {
  ...
  _markPrivateTab(tab) {
    tab.toggleAttribute("wildbuzzard-private", true);
  ...
  _initMenus(win) {
    ...
    // webext-panels.xhtml does not load browser/wildbuzzard/private-tabs.ftl;
    ...
    // browser.xhtml supplies browser/wildbuzzard/private-tabs.ftl here.
