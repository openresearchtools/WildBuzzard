...
export const WILDBUZZARD_THEME_MODE_PREF = "browser.theme.wildbuzzard.mode";
export const WILDBUZZARD_THEME_COLOR_PREF = "browser.theme.wildbuzzard.color";
export const WILDBUZZARD_THEME_ID =
  "wildbuzzard-dynamic-theme@wildbuzzard.invalid";
...
const IN_CONTENT_THEME_EXPERIMENT = Object.freeze({
  colors: {
    wildbuzzard_accent_primary: "--color-accent-primary",
    wildbuzzard_accent_primary_hover: "--color-accent-primary-hover",
    wildbuzzard_accent_primary_active: "--color-accent-primary-active",
    wildbuzzard_background_color_information: "--background-color-information",
    wildbuzzard_icon_color_information: "--icon-color-information",
  },
});
...
const PALETTES = {
  ...
  smoke: {
    labelId: "wildbuzzard-onboarding-color-smoke-label",
    swatch:
  ...
  ash: {
    labelId: "wildbuzzard-onboarding-color-ash-label",
    swatch:
  ...
  sun: {
    labelId: "wildbuzzard-onboarding-color-sun-label",
    swatch:
  ...
  spark: {
    labelId: "wildbuzzard-onboarding-color-spark-label",
    swatch:
  ...
  flame: {
    labelId: "wildbuzzard-onboarding-color-flame-label",
    swatch:
  ...
  flare: {
    labelId: "wildbuzzard-onboarding-color-flare-label",
    swatch:
  ...
  lavender: {
    labelId: "wildbuzzard-onboarding-color-lavender-label",
    swatch:
  ...
  dusk: {
    labelId: "wildbuzzard-onboarding-color-dusk-label",
    swatch:
  ...
  lagoon: {
    labelId: "wildbuzzard-onboarding-color-lagoon-label",
    swatch:
  ...
  tide: {
    labelId: "wildbuzzard-onboarding-color-tide-label",
    swatch:
  ...
  pine: {
    labelId: "wildbuzzard-onboarding-color-pine-label",
    swatch:
...
function deriveInContentColors(colors, variant) {
  ...
  return {
    wildbuzzard_accent_primary: accent,
    wildbuzzard_accent_primary_hover: mixHexColor(
      accent,
      contrastMixColor,
      0.12
    ),
    wildbuzzard_accent_primary_active: mixHexColor(
      accent,
      contrastMixColor,
      0.24
    ),
    wildbuzzard_background_color_information: mixHexColor(
      accent,
      subtleMixColor,
      isLight ? 0.88 : 0.62
    ),
    wildbuzzard_icon_color_information: accent,
  };
}
...
export const WildBuzzardThemeColors = {
  _initialized: false,
  ...
  init() {
    ...
    Services.prefs.addObserver(WILDBUZZARD_THEME_MODE_PREF, this);
    Services.prefs.addObserver(WILDBUZZARD_THEME_COLOR_PREF, this);
  ...
  uninit() {
    ...
    Services.prefs.removeObserver(WILDBUZZARD_THEME_MODE_PREF, this);
    Services.prefs.removeObserver(WILDBUZZARD_THEME_COLOR_PREF, this);
  ...
  getMode() {
    return normalizeMode(
      Services.prefs.getStringPref(WILDBUZZARD_THEME_MODE_PREF, DEFAULT_MODE)
    );
  },

  getColor() {
    return normalizeColor(
      Services.prefs.getStringPref(WILDBUZZARD_THEME_COLOR_PREF, DEFAULT_COLOR)
    );
  },
